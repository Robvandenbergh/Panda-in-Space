...
/*
state_machine_init();
state_create("spawn",state_player_spawn);
state_create("alive",state_player_alive);
state_create("moving",state_player_moving);
state_create("shootinglmouseb",state_player_shootinglmouseb);
state_create("shootingrmouseb",state_player_shootingrmouseb);
state_create("dead",state_player_dead);
state_init("spawn");

//definieer hier de FSM
